      ...
      <Row className="justify-content-center">
        <Col>
          <Card className="border-0">
            <Card.Body>
              <p>
                Any society, trust, or charitable company carrying on educational, charitable, religious, economic, cultural, or social welfare activities and desirous of receiving any foreign contribution from a foreign source is required to obtain registration under section 6(1) of the Act. Any association that is not registered, or which has been denied registration, can receive foreign contribution only after obtaining prior permission from the Central Government under section 6(1A) of the Act.
              </p>
              <h4>Who Can Accept Foreign Contribution?</h4>
              <p>
                Organizations working for definite cultural, social, economic, educational, or religious programs can accept foreign contributions if and only if they are registered with the Home Ministry. They must also maintain a separate account listing the donations received from foreigners, get it audited by a Chartered Accountant, and submit it to the Home Ministry every year.
              ...
              <h4>Foreign Contribution (Regulation) Amendment Bill 2020: Amendments and Process</h4>
              <ul>
                <li>
                  <h5>Eligibility for Registration:</h5>
                  <p>Entities eligible for registration under FCRA typically include non-governmental organizations (NGOs), associations, and other entities involved in activities of national or social importance.</p>
                </li>
                <li>
                  <h5>Prior Permission or Registration:</h5>
                  <p>Organizations seeking to receive foreign contributions need to obtain either prior permission or registration from the Ministry of Home Affairs (MHA), Government of India.</p>
                </li>
                <li>
                  <h5>Application Process:</h5>
                  <p>
                    <strong>a. Prior Permission:</strong> Organizations can apply for prior permission if they plan to receive foreign contributions for a specific project or event.
                    <br />
                    <strong>b. Registration:</strong> Organizations can apply for registration if they wish to receive foreign contributions on a regular basis.
                  </p>
                </li>
                <li>
                  <h5>Application Form:</h5>
                  <p>The application is submitted in the prescribed form along with supporting documents, including details about the nature of activities, sources of income, and the purpose for which foreign contributions are sought.</p>
                </li>
                <li>
                  <h5>Online Submission:</h5>
                  <p>The application process is typically done online through the FCRA portal.</p>
                </li>
                <li>
                  <h5>Scrutiny and Verification:</h5>
                  <p>The Ministry scrutinizes the application, and a thorough verification process is conducted to ensure the legitimacy and compliance of the organization.</p>
                </li>
                <li>
                  <h5>Decision on Application:</h5>
                  <p>The Ministry makes a decision on whether to grant prior permission or registration based on the merits of the application and the organization's compliance with FCRA regulations.</p>
                </li>
                <li>
                  <h5>Validity and Renewal:</h5>
                  <p>Registration granted under FCRA is initially valid for five years. Organizations can apply for renewal before the expiry of the validity period.</p>
                </li>
                <li>
                  <h5>Utilization of Funds:</h5>
                  <p>Organizations must use foreign contributions for the specific purpose mentioned in the application and adhere to the guidelines provided by the FCRA.</p>
                </li>
                <li>
                  <h5>Reporting and Compliance:</h5>
                  <p>Registered organizations are required to submit annual returns and maintain proper accounts of the foreign contributions received and utilized.</p>
                </li>
                <li>
                  <h5>Changes Introduced by FCRA Amendment Bill 2020:</h5>
                  <p>The FCRA Amendment Bill 2020 introduces stricter provisions, including enhanced scrutiny, the prohibition of transfer of foreign contributions, and restrictions on administrative expenses.</p>
                </li>
                <li>
                  <h5>Legal Consultation:</h5>
                  <p>Organizations are advised to seek legal consultation to ensure compliance with the latest FCRA regulations and amendments.</p>
                </li>
              </ul>
              <p>
                <strong>Note:</strong> Given the evolving nature of legislation, it's essential to refer to the latest amendments and guidelines issued by the Ministry of Home Affairs for the most accurate and updated information.
              </p>
            </Card.Body>
          </Card>
        </Col>
