  ...
  const links = [
    ...
    },
    {
      ...
      navLinks: [
        ...
        { text: "Income tax Return", url: "/income-tax-advisory" },
        ...
        { text: "TDS returns and filings ", url: "/" },
        { text: "Advance Tax Calculation and Filing", url: "/" },
      ],
    },
    {
      ...
      navLinks: [
        ...
        { text: "GST registration", url: "/gst-and-indirect-tax" },
        { text: "GST returns and filings", url: "/gst-and-indirect-tax" },
